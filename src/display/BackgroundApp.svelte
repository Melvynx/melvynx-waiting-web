...
<div class="full-width-container">
  <div class="display-animation-checkbox-container">
    <label for="display-animation-checkbox">Display animations :</label>
    <input
      id="display-animation-checkbox"
      type="checkbox"
      bind:checked={displayAnimation}
    />
  </div>
...
<style>
  ...
  .display-animation-checkbox-container {
    display: flex;
    align-items: center;
    margin: 8px;
  }

  .display-animation-checkbox-container > input {
    margin: 0 0 0 8px;
